...
MU_TEST(test_parse_cell_data_z_forty_two)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_z_forty_two_white_uppercase)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_short_color_hex)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_invalid_z_value)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_invalid_color)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_invalid_color_hex)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
MU_TEST(test_parse_cell_data_invalid_color_format)
{
	// ARRANGE
	int	expected_return;
	int	actual_return;
...
int	test_parse_cell_data(void) {
	MU_RUN_SUITE(parse_cell_data_test_suite);
	MU_REPORT();
	return MU_EXIT_CODE;
}
